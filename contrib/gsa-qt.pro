...
RESOURCES += src/qt/gsa.qrc src/qt/gsa_locale.qrc

TRANSLATIONS += src/qt/locale/gsa_bg.ts \
                src/qt/locale/gsa_de.ts \
                src/qt/locale/gsa_en.ts \
                src/qt/locale/gsa_es.ts \
                src/qt/locale/gsa_fi.ts \
                src/qt/locale/gsa_fr.ts \
                src/qt/locale/gsa_it.ts \
                src/qt/locale/gsa_ja.ts \
                src/qt/locale/gsa_pl.ts \
                src/qt/locale/gsa_pt.ts \
                src/qt/locale/gsa_ru.ts \
                src/qt/locale/gsa_sk.ts \
                src/qt/locale/gsa_sv.ts \
                src/qt/locale/gsa_vi.ts \
                src/qt/locale/gsa_zh_CN.ts \
                src/qt/locale/gsa_zh_TW.ts
