...
* Fill in the following data:
    * Application Name: `GlobalSmartAsset Core`
    * Application Version: `1.2.0.0`
    * Application Publisher: `2020 GlobalSmartAsset Core Developers`
    * Application Website: `https://gsasset.io/`
* Setup the destination folder:
    * Program Files Folder
    * Folder name: `GlobalSmartAsset`
* Add application files:
    * Select the file `gsa-pt.exe` as main executable from the `package` folder
...
* Compiler settings
    ...
    * Edit the output base filename to: `gsa-1.1.0-win64-setup.exe`
