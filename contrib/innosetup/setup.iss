...
#define MyAppName "GlobalSmartAsset Core"
#define MyAppPublisher "2021 GLOBALSMARTASSET Core Developers"
#define MyAppURL "https://gsasset.io"
#define MyAppExeName "gsa-qt.exe"
#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/GSA/bootstrap.zip"
...
DefaultDirName={autopf}\GlobalSmartAsset
...
OutputDir=.\output
OutputBaseFilename=GlobalSmartAssetSetup
...
DefaultGroupName=GlobalSmartAsset Core
...
[Files]
Source: ".\package\gsa-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\GlobalSmartAsset\GlobalSmartAsset-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\GlobalSmartAsset\GlobalSmartAsset-Qt,strDataDir|{userappdata}\GlobalSmartAsset\}');
  Result := True;
end;
