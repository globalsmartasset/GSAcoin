...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='globalsmartasset.conf'
CONFIGFOLDER='/root/.globalsmartasset'
COIN_DAEMON='gsad'
COIN_CLI='gsa-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/gsacoin-com/GSA/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='globalsmartasset'
COIN_PORT=45328
RPC_PORT=45329
