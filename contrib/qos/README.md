...
This means one can have an always-on gsad instance running, and another local gsad/gsa-qt instance which connects to this node and receives blocks from it.
