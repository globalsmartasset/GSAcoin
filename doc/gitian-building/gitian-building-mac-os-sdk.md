...
The script [extract-osx-sdk.sh](https://github.com/gsa-project/gsa/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
gsa/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/gsa-project/gsa/blob/master/doc/README_osx.md) for troubleshooting tips.