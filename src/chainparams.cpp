...
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1575267890, // * UNIX timestamp of last checkpoint block
    52,   // * total number of transactions between genesis and last checkpoint
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1556161666, 1426141, 0x1e0ffff0, 1, 1 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(genesis.hashMerkleRoot == uint256S("0xd15ba80949cd01eb7c404f42b0692421a363311ba0cc0759a1d8eddfb78f8bf9"));
        assert(consensus.hashGenesisBlock == uint256S("0x000009738352ce62459bd0b596e7fb80f234e65ce514b0e8c31e9b4f3551eccb"));
        ...
        consensus.nMaxMoneyOut = 26000000 * COIN;
        ...
        consensus.nTargetTimespanV2 = 5 * 60;
        ...
        consensus.vUpgrades[Consensus::UPGRADE_POS_V2].nActivationHeight                 = 935001;
        consensus.vUpgrades[Consensus::UPGRADE_ZC].nActivationHeight                     = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_V2].nActivationHeight                  = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].nActivationHeight                  = 935101;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_PUBLIC].nActivationHeight              = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        consensus.vUpgrades[Consensus::UPGRADE_STAKE_MODIFIER_V2].nActivationHeight      = 935201;
        consensus.vUpgrades[Consensus::UPGRADE_TIME_PROTOCOL_V2].nActivationHeight       = 935301;
        consensus.vUpgrades[Consensus::UPGRADE_P2PKH_BLOCK_SIGNATURES].nActivationHeight = 935401;
        consensus.vUpgrades[Consensus::UPGRADE_STAKE_MIN_DEPTH_V2].nActivationHeight     = 935501;
        consensus.vUpgrades[Consensus::UPGRADE_CHECK_WORK_V2].nActivationHeight          = 940001;
        consensus.vUpgrades[Consensus::UPGRADE_MASTERNODE_RANK_V2].nActivationHeight     = 950001;

        consensus.vUpgrades[Consensus::UPGRADE_POS].hashActivationBlock                    = uint256S("7c06d7a70abec264cc54f1d94c04da6a88583ab90ddb6511ea81ed4721453b85");
        ...
        vSeeds.emplace_back(CDNSSeedData("seeder", "149.28.152.252", true));
        vSeeds.emplace_back(CDNSSeedData("seed1",  "104.238.185.199", true));
        vSeeds.emplace_back(CDNSSeedData("seed2",  "155.138.196.140", true));
        vSeeds.emplace_back(CDNSSeedData("seed3",  "139.180.203.94", true));
        vSeeds.emplace_back(CDNSSeedData("seed4",  "78.141.212.192", true));
        vSeeds.emplace_back(CDNSSeedData("seed5",  "217.69.11.2", true));
        vSeeds.emplace_back(CDNSSeedData("seed6",  "139.180.218.229", true));
        vSeeds.emplace_back(CDNSSeedData("seed7",  "45.76.117.60", true));
        vSeeds.emplace_back(CDNSSeedData("seed8",  "78.141.202.48", true));
        vSeeds.emplace_back(CDNSSeedData("seed8",  "66.42.80.247", true));
        vSeeds.emplace_back(CDNSSeedData("seed8",  "149.28.86.212", true));
...
public:
    CTestNetParams()
    {
        ...
        consensus.fPowAllowMinDifficultyBlocks = false;
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // globalsmartasset starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        vSeeds.emplace_back(CDNSSeedData("tseeder", "tseeder.gsasset.io", true));
        vSeeds.emplace_back(CDNSSeedData("tseed1",  "tseed1.gsasset.io", true));
        vSeeds.emplace_back(CDNSSeedData("tseed2",  "tseed2.gsasset.io", true));
        vSeeds.emplace_back(CDNSSeedData("tseed3",  "tseed3.gsasset.io", true));
        vSeeds.emplace_back(CDNSSeedData("tseed4",  "tseed4.gsasset.io", true));
        vSeeds.emplace_back(CDNSSeedData("tseed5",  "tseed5.gsasset.io", true));
        vSeeds.emplace_back(CDNSSeedData("tseed6",  "tseed6.gsasset.io", true));
        vSeeds.emplace_back(CDNSSeedData("tseed7",  "tseed7.gsasset.io", true));
        vSeeds.emplace_back(CDNSSeedData("tseed8",  "tseed8.gsasset.io", true));
