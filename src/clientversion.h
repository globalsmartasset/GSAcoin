...
#error Client version information missing: version is not defined by gsa-config.h or in any other way
#endif
...
/**
 * gsad-res.rc includes this file, but it cannot cope with real c++ code.
