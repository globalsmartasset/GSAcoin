/* src/config/gsa-config.h.  Generated from gsa-config.h.in by configure.  */
/* src/config/gsa-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://github.com/gsacoin-com/GSA/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "GlobalSmartAsset Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "GlobalSmartAsset Core 5.0.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "globalsmartasset"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://gsasset.io/"
