...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GlobalSmartAsset gsa-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  gsa-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded globalsmartasset transaction") + "\n" +
                               "  gsa-tx [options] -create [commands]   " + _("Create hex-encoded globalsmartasset transaction") + "\n" +
                               "\n";
