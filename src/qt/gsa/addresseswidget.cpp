...
#include "qt/gsa/forms/ui_addresseswidget.h"
#include "qt/gsa/addresslabelrow.h"
#include "qt/gsa/addnewaddressdialog.h"
#include "qt/gsa/tooltipmenu.h"
...
void AddressesWidget::onStoreContactClicked()
{
    if (walletModel) {
        ...
        CTxDestination gsaAdd = DecodeDestination(address.toUtf8().constData());
        ...
        if (walletModel->updateAddressBookLabels(
            gsaAdd, label.toUtf8().constData(),AddressBook::AddressBookPurpose::SEND
        )) {
