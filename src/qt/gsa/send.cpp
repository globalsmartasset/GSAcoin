...
#include "qt/gsa/send.h"
#include "qt/gsa/forms/ui_send.h"
#include "qt/gsa/addnewcontactdialog.h"
#include "qt/gsa/qtutils.h"
#include "qt/gsa/sendchangeaddressdialog.h"
#include "qt/gsa/optionbutton.h"
#include "qt/gsa/sendconfirmdialog.h"
#include "qt/gsa/myaddressrow.h"
#include "qt/gsa/guitransactionsutils.h"
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-gsa");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination gsaAdd = DecodeDestination(address.toStdString());
        if (walletModel->isMine(gsaAdd)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(gsaAdd, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {
