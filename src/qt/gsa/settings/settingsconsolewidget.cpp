...
#include "qt/gsa/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/gsa/settings/moc_settingsconsolewidget.cpp"
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the GSA RPC console.") + "<br>" +
