...
#include "qt/gsa/forms/ui_topbar.h"
#include "qt/gsa/loadingdialog.h"
#include "qt/gsa/lockunlock.h"
#include "qt/gsa/qtutils.h"
#include "qt/gsa/receivedialog.h"
                                                        ...
                                                        ui(new Ui::TopBar)
{
    ...
    ui->pushButtonConf->setButtonText("globalsmartasset.conf");
...
void TopBar::onBtnConfClicked()
{
    ...
    if (!GUIUtil::openConfigfile())
        inform(tr("Unable to open globalsmartasset.conf with default application"));
}
