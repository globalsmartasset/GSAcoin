                                                                    ...
                                                                    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("GlobalSmartAsset") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
/* On x86 add a bit specifier to the version so that users can distinguish between
    ...
    if (about) {
        setWindowTitle(tr("About GlobalSmartAsset"));
        ...
        QString header = tr("Usage:") + "\n" +
                         "  gsa-qt [" + tr("command-line options") + "]                     " + "\n";
...
ShutdownWindow::ShutdownWindow(QWidget* parent, Qt::WindowFlags f) : QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("GlobalSmartAsset is shutting down...") + "<br /><br />" +
        tr("Do not shut down the computer until this window digsaears.")));
    setLayout(layout);
}
