...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GSA features */
        {"globalsmartasset", "listmasternodes", &listmasternodes, true },
        {"globalsmartasset", "getmasternodecount", &getmasternodecount, true },
        {"globalsmartasset", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"globalsmartasset", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"globalsmartasset", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"globalsmartasset", "masternodecurrent", &masternodecurrent, true },
        {"globalsmartasset", "startmasternode", &startmasternode, true },
        {"globalsmartasset", "createmasternodekey", &createmasternodekey, true },
        {"globalsmartasset", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"globalsmartasset", "listmasternodeconf", &listmasternodeconf, true },
        {"globalsmartasset", "getmasternodestatus", &getmasternodestatus, true },
        {"globalsmartasset", "getmasternodewinners", &getmasternodewinners, true },
        {"globalsmartasset", "getmasternodescores", &getmasternodescores, true },
        {"globalsmartasset", "preparebudget", &preparebudget, true },
        {"globalsmartasset", "submitbudget", &submitbudget, true },
        {"globalsmartasset", "mnbudgetvote", &mnbudgetvote, true },
        {"globalsmartasset", "getbudgetvotes", &getbudgetvotes, true },
        {"globalsmartasset", "getnextsuperblock", &getnextsuperblock, true },
        {"globalsmartasset", "getbudgetprojection", &getbudgetprojection, true },
        {"globalsmartasset", "getbudgetinfo", &getbudgetinfo, true },
        {"globalsmartasset", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"globalsmartasset", "mnfinalbudget", &mnfinalbudget, true },
        {"globalsmartasset", "checkbudgets", &checkbudgets, true },
        {"globalsmartasset", "mnsync", &mnsync, true },
        {"globalsmartasset", "spork", &spork, true },
        ...
        {"zerocoin", "getzgsaseed", &getzgsaseed, false },
        {"zerocoin", "setzgsaseed", &setzgsaseed, false },
        {"zerocoin", "generatemintlist", &generatemintlist, false },
        {"zerocoin", "searchdzgsa", &searchdzgsa, false },
        {"zerocoin", "dzgsastate", &dzgsastate, false },
...
{
    return "> gsa-cli " + methodname + " " + args + "\n";
}
