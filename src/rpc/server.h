...
extern UniValue setzgsaseed(const JSONRPCRequest& request);
extern UniValue getzgsaseed(const JSONRPCRequest& request);
extern UniValue generatemintlist(const JSONRPCRequest& request);
extern UniValue searchdzgsa(const JSONRPCRequest& request);
extern UniValue dzgsastate(const JSONRPCRequest& request);
