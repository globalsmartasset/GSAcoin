...
"""Verify that starting globalsmartasset with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start globalsmartasset with -? for help text")
        ...
        self.log.info("Start globalsmartasset with -version for version information")
